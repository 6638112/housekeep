                                            ...
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    ...
                                                    <a type="button" class="btn btn-success btn-sm"
                                                       onclick="addLwCourseChapter()" id="btn-add">
                            ...
                            <div class="col-xs-12">
                                <table id="lwCourseChapter" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                       ...
                                       <th style="background-color: #E5E5E5">url</th>
                                       ...
                                       <th style="background-color: #E5E5E5">播放类型</th>
                                       <th style="background-color: #E5E5E5">房间最多人数</th>
                                       <th style="background-color: #E5E5E5">可以提前的秒数</th>
                                       <th style="background-color: #E5E5E5">老师字节码</th>
                                        <th style="background-color: #E5E5E5">管理员字节码</th>
...
<script>
    $(function () {
        ...
        var userParam = {
            getQueryCondition: function (data) {
                var param = {};
                param.courseName = $("#nickNameSearch").val();
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/cms/coursechapter/getList.do?chapterType=0&courseType=0',//请求数据的参数
            ...
            columns: [
...

                {
                    ...
                    render: function (data) {
                        switch (data){
                            case 1 : return "一对一课"; break;
                            case 2 : return "班课"; break;
                            default : return "暂无类型"; break;
                        }
                    }
                },
                {
                    ...
                    render: function (data) {
                        switch (data){
                            case 0 : return "视频课"; break;
                            case 1 : return "音频课"; break;
                            default : return "暂无播放类型"; break;
                        }
                    }
                },
                {
...

                {
                    ...
                    render: function (data, type, row) {
                        return '<a class="btn  btn-sm btn-info" href="#modal-edit" data-toggle="modal"  data-backdrop="static" ' +
                                'onclick="updateCourseChapter(\'' + data + '\')">' +
                                '<i class="ace-icon fa fa-pencil-square-o "></i>修改</a>' +
                                '&nbsp;&nbsp;' +
                                '<a class="btn btn-sm btn-danger" onclick="delCourseChapter(\'' + data + '\')">' +
    ...
    function addLwCourseChapter() {
        window.location.href = "${dynamicServer}/cms/coursechapter/toAdd.do?type=0";
    }

    function updateCourseChapter(id) {

        window.location.href = "${dynamicServer}/cms/coursechapter/toUpdate.do?type=0&id=" + id;
    }

    /*删除*/
    function delCourseChapter(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除章节？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
