                                ...
                                <div class="widget-main no-padding">
                                    <form:form action="/" method="post"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-6 col-lg-5">资料状态：</label>
                                                    <div class="col-xs-6 col-lg-7">
                                                        <select name="statusSearch" id="statusSearch" class="col-sm-12 col-lg-7" title="">
                                                            <option value="" selected="selected">请选择</option>
                                                            <option value="0">已创建待付款</option>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="lwVoucherForm" name="lwVoucherForm" class="form-horizontal"
                              action="${dynamicServer}/cms/order/updateState.do" method="post">
                ...
                <div class="widget-box" style="border: none">
                    <div class="widget-body">
                        <div class="widget-main">
                            <c:url value="${dynamicServer}/cms/order/export.do"
                                   var="import_url"/>
                ...
                <div class="widget-box" style="border: none">
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <c:url value="${dynamicServer}/cms/order/import.do"
                                   var="import_url"/>
    ...
    $(function () {
        ...
        var userParam = {
            getQueryCondition: function (data) {
                var param = {};
                param.externalNo = $("#externalNoSearch").val();
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/cms/order/getList.do',//请求数据的参数
...
//                        if (row.status == 1) {
//                            button += '&nbsp;&nbsp;<a class="btn btn-sm btn-info" href="#modal-delivery" data-toggle="modal" data-backdrop="static" onclick="updateDelivery(\'' + data  + '\')">' +
...
//
    ...
    function checkDepartment(id) {
        window.location.href = "${dynamicServer}/cms/order/toUpdate.do?id=" + id+"&check=1";
    }

    /*跳转页面修改数据*/
    function updateDepartment(id) {
        window.location.href = "${dynamicServer}/cms/order/toUpdate.do?id=" + id;
    }
    <%--/*修改时需要回显数据*/--%>
    <%--function updateDepartment(id) {--%>
    ...
    function delDepartment(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该订单信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/cms/order/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
