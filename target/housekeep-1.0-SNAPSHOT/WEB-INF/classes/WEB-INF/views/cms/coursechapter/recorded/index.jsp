                    ...
                    <div class="col-xs-12">
                        <form id="lwCourseChapterForm" name="lwCourseChapterForm" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="url" name="url" maxlength="255" class="col-xs-10 col-sm-7"
                                           placeholder=""
                                           title="" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="timeLength" name="timeLength" maxlength="5" class="col-xs-10 col-sm-7"
                                           placeholder=""
                                           title="" value="">
                                </div>
                            </div>
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
//                    面授章节
                    url: '${dynamicServer}/cms/coursechapter/getList.do?chapterType=0&courseType=1',//请求数据的参数
