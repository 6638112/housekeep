                            ...
                            <div class="col-xs-12">
                                <table id="lwCourseChapter" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="background-color: #E5E5E5">时长</th>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="lwCourseChapterForm" name="lwCourseChapterForm" class="form-horizontal"
                              action="${dynamicServer}/cms/coursechapter/save.do?chapterType=1" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="title" name="title" maxlength="256"
                                           ...
                                           placeholder=""
                                           title="" value="">&nbsp;&nbsp;<label id="titleTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="timeLength" name="timeLength" maxlength="256"
                                           class="col-xs-10 col-sm-7"
                                           placeholder=""
                                           title="" value="">&nbsp;&nbsp;<label id="timeLengthTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="url" name="url" maxlength="256"
                                           class="col-xs-10 col-sm-7"
                                           placeholder=""
                                           title="" value="">&nbsp;&nbsp;<label id="urlTip"></label>
                                </div>
                            </div>
    ...
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/cms/coursechapter/getList.do?chapterType=1',//请求数据的参数
