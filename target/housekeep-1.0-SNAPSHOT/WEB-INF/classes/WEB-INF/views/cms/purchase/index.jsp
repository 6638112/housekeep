                            ...
                            <div class="col-xs-12">
                                <table id="lwInvitation" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th style="background-color: #E5E5E5">抢购课程</th>

                                        <th style="background-color: #E5E5E5">开始时间</th>
                                        <th style="background-color: #E5E5E5">结束时间</th>
                                        <th style="background-color: #E5E5E5">活动价格(元)</th>
                                        <th style="background-color: #E5E5E5">下单人数</th>
                                        <th style="background-color: #E5E5E5">成功人数</th>
                                        <th style="background-color: #E5E5E5">当前状态</th>
    ...
    <div class="modal-dialog" style="width: 50%;top: 18%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">课程抢购</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-12">
                        <form id="lwInvitationForm" name="lwInvitationForm" class="form-horizontal"
                              action="${dynamicServer}/cms/purchase/save.do" method="post">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">抢购课程：</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="price" name="price" maxlength="256"
                                           class="col-xs-10 col-sm-7" placeholder=""
                                           title="" value="">
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-offset-4 col-md-8">
                                    <button class="btn btn-primary btn-sm" type="submit" id="button-add">
    ...
    $(function () {
        ...
        var userParam = {
            getQueryCondition: function (data) {
                ...
                param.courseName = $("#PrefixSearch").val();
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/cms/purchase/getList.do',//请求数据的参数
                    ...
                    render: function (data, type, row) {
                        var button =
                            ...
                            if (row.state == 0 ||row.state==null) {
                                button += '&nbsp;&nbsp;<a class="btn btn-sm btn-warning" onclick="cancelVoucher(\'' + data  + '\', 1)">' +
                                    '<i class="ace-icon fa fa-pencil-square-o "></i>发布</a>';
                            } else if (row.state == 1) {
                                button += '&nbsp;&nbsp;<a class="btn btn-sm btn-success" onclick="cancelVoucher(\'' + data  + '\', 2 )">' +
                                    '<i class="ace-icon fa fa-pencil-square-o "></i>结束</a>';
                            }
...
//                            '<a class="btn btn-sm btn-warning" onclick="cancelVoucher(\'' + data + '\')">' +
...
//                var data = eval("("+text+")");
    ...
    function cancelVoucher(id,state) {
        ...
        bootbox.confirm("<a style='font-size: 17px;color: red'>"+altStr+"</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/cms/purchase/cancelVoucher.do",
                    data: {
                        "id": id,
                        "state":state
                    },
    ...
    function updateInvitation(id) {
        ...
        $.ajax({
            type: "GET",
            url: "${dynamicServer}/cms/purchase/findOne.do",
            data: {
                "id": id
            },
            contentType: 'application/json',
    ...
    function delInvitation(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该代金券信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/cms/purchase/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
