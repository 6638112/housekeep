                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="departmentForm" name="departmentForm" class="form-horizontal"
                              action="${dynamicServer}/portal/organization/department/save.do" method="post">
                        ...
                        <div class="widget-main">
                            <div class="form-group">
                                <div class="col-xs-12" style="margin-bottom: 10px">
                                    ...
                                    <a href="${staticServer}/upload/model/department-model-import.xls">导入部门模板.xls</a>
                                </div>
                            </div>
                            <c:url value="${dynamicServer}/portal/organization/department/import.do"
                                   var="import_url"/>
    ...
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/portal/organization/department/getList.do',//请求数据的参数
...
//
    ...
    function updateDepartment(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/portal/organization/department/findOne.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
    ...
    function delDepartment(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该部门信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/portal/organization/department/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
    ...
    function exportTable() {
        window.location = "${dynamicServer}/portal/organization/department/export.do";
    }
</script>
</body>
</html>
