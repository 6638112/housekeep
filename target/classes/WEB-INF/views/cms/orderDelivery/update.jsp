                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="infoForm" name="infoForm" class="form-horizontal"
                            ...
                            <input type="hidden" value="${lwOrder.consignee}" id="consignee" name="consignee"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="deliveryCompany" name="deliveryCompany" maxlength="256"
                                           class="col-xs-10 col-sm-7" placeholder=""
                                           title="" value="${lwOrderDelivery.deliveryCompany}" required <c:if test="${check==1}">readonly</c:if>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="deliveryNumber" name="deliveryNumber" maxlength="256"
                                           class="col-xs-10 col-sm-7" placeholder=""
                                           title="" value="${lwOrderDelivery.deliveryNumber}" required <c:if test="${check==1}">readonly</c:if>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" id="deliveryDate" name="deliveryDate" maxlength="256"
                                           class="col-xs-12 col-sm-7" placeholder=""
                                           title="" value="${lwOrderDelivery.deliveryDate}" data-date-format="yyyy.mm.dd hh:ii" required <c:if test="${check==1}">readonly</c:if>>
                                    <label id="deliveryDateTip"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">发货人：</label>
                                <div class="col-sm-9">
                                    <input type="text" id="deliveryPerson" name="deliveryPerson" maxlength="256"
                                           class="col-xs-10 col-sm-7" placeholder=""
                                           title="" value="${lwOrderDelivery.deliveryPerson}" readonly>
                                    <label id="deliveryPersonTip"></label>
                                </div>
                            </div>
                            <c:if test="${check!=1}">
