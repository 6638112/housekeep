                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="lwUser" class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <th style="background-color: #E5E5E5">用户编号</th>
                                        <th style="background-color: #E5E5E5">手机号</th>
                                        <th style="background-color: #E5E5E5">姓名</th>
                                        <th style="background-color: #E5E5E5">是否安装App</th>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form id="lwUserForm" name="lwUserForm" class="form-horizontal"
                              action="${dynamicServer}/cms/teachermapping/save.do" method="post">
                ...
                <div class="widget-box" style="border: none">
                    <div class="widget-body">
                        <div class="widget-main">
                            ...
                            <c:url value="${dynamicServer}/cms/teachermapping/import.do"
                                   var="import_url"/>
...
<script>
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/cms/teachermapping/getList.do',//请求数据的参数
    ...
    function flushForm() {
        ...
        $.ajax({
            type: "get",
            url: "${dynamicServer}/cms/teachermapping/findAll.do",
    ...
    function updateDepartment(id) {
        ...
        $.ajax({
            type: "GET",
            url: "${dynamicServer}/cms/teachermapping/findOne.do",
            data: {
                "id": id
            },
            contentType: 'application/json',
    ...
    function delDepartment(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该用户信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/cms/teachermapping/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
