                                        ...
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-6 col-lg-5">用户数量：</label>
                    ...
                    <div class="col-xs-12">
                        <form id="lwInvitationForm" name="lwInvitationForm" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                        <textarea id="actIntroduce" name="actIntroduce" class="col-xs-12 col-sm-7" rows="5"
                                                  placeholder="请输入活动描述..."
