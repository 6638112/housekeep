                        ...
                        <form id="infoForm" name="infoForm" class="form-horizontal"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 control-div">
                                    <ul id="imageUl" class="ace-thumbnails clearfix <c:if test="${empty img.imgUrl}">hidden</c:if>""
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="dispatcheObj" id="dispatcheObj" class="col-sm-12 col-lg-7" title="">
                                        <option value="0" <c:if test="${skipType==0}">selected</c:if>>无跳转</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select name="state" id="state" class="col-sm-12 col-lg-7" title="">
                                        <option value="0" <c:if test="${img.state==0}" ><c:out value="selected" /></c:if>>暂不生效</option>
                                        <option value="1" <c:if test="${img.state==1}" ><c:out value="selected" /></c:if>>马上生效</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
