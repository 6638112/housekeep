                                        ...
                                        <div class="row">
                                            <div class="col-xs-3">
                                                <div class="form-group">
                                                    <label class="control-label col-xs-6 col-lg-5">标题 ：</label>
                                                    <div class="col-xs-6 col-lg-7">
                                                        <input id="typeSearch" name="typeSearch" value="">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <table id="lwTeacher" style="width: 100%"
                                    ...
                                    <thead>
                                    <tr>
                                        <th style="background-color: #E5E5E5">Icon</th>
                                        <%--<th style="background-color: #E5E5E5">课程名称</th>--%>
                                        <th style="background-color: #E5E5E5">标题</th>
...
<script>
    ...
    function addTeacher() {
        window.location.href = "${dynamicServer}/cms/news/toAdd.do";
    }

    function updateTeacher(id) {
        window.location.href = "${dynamicServer}/cms/news/toUpdate.do?id=" + id;
    }
    ...
    $(function () {
        ...
        window.table = $table_id.DataTable({
            ...
            ajax: function (data, callback) {//ajax配置为function,手动调用异步查询
                $.ajax({
                    type: "GET",
                    url: '${dynamicServer}/cms/news/getList.do',//请求数据的参数
...
//                },
    ...
    function flushForm() {
        ...
        $.ajax({
            type: "get",
            url: "${dynamicServer}/cms/news/findAll.do",
    ...
    function updateUser(id) {
        ...
        $.ajax({
            type: "GET",
            url: "${dynamicServer}/cms/news/findOne.do",
            data: {
                "id": id
            },
            contentType: 'application/json',
    ...
    function delUser(id) {
        bootbox.confirm("<a style='font-size: 17px;color: red'>确定要删除该用户信息？</a>", function (result) {
            if (result) {
                $.ajax({
                    type: "GET",
                    url: "${dynamicServer}/cms/news/delete.do",
                    data: {
                        "id": id
                    },
                    contentType: 'application/json',
