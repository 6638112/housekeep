...
import com.connxun.sys.model.SysRoleFunction;
...
public class SysFunctionDao {
    ...
    public int add(SysFunction sysFunction) {
        ...
        String sql = "INSERT INTO sys_function(module_id,name,code,url,type,description,display_order) VALUES(:module_id,:name,:code,:url,:type,:description,:display_order)";
