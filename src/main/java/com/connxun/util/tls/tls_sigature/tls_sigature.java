//package com.connxun.util.tls.tls_sigature;
//
...
//			return "CheckTLSSignatureResult [errMessage=" + errMessage
//					+ ", verifyResult=" + verifyResult + ", expireTime="
...
//			"MIGEAgEAMBAGByqGSM49AgEGBSuBBAAKBG0wawIBAQQgM+xHvCOX3W/TgV5Rp8if\n" +
//			"NZ+jfU4/Q1zJP318dA+wTbWhRANCAAQpHOSmRpRbp8ISmXo9goK1+BnkydUhNW64\n" +
//			"pmSDPbJt3iIIwPHD76byEhTSWsq5M+nzysBTKdvEMdfnoCWfWMEf\n" +
//			"-----END PRIVATE KEY-----";
//
//			//change public pem string to public string
//			String pubStr = "-----BEGIN PUBLIC KEY-----\n"+
//			"MFYwEAYHKoZIzj0CAQYFK4EEAAoDQgAEKRzkpkaUW6fCEpl6PYKCtfgZ5MnVITVu\n"+
//			"uKZkgz2ybd4iCMDxw++m8hIU0lrKuTPp88rAUynbxDHX56Aln1jBHw==\n"+
//			"-----END PUBLIC KEY-----";
//
//            // generate signature
//            GenTLSSignatureResult result = GenTLSSignatureEx(1400019251, "test", privStr);
...
//
//            // check signature
//            CheckTLSSignatureResult checkResult = CheckTLSSignatureEx(result.urlSig, 1400019251, "test", pubStr);
